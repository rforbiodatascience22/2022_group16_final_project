...
![](../results/BMIclass_age_dx.png){width=100%, height=80%}
...
Diagnosis of DM correlates with age, blood glucose, bmi, .... 
Income and race does not appear to predict DM diagnosis or treatment status
Blood glucose overrules other variables in predicting DM diagnosis
Cannot cluster patients based on these variables alone
