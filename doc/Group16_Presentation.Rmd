...
Normal range is 0.6 - 1.2 mg/dL, 5+ indicates severe kidney impairment. We removed all values above 5 (17 total values).
...
![](../results/tx_Ethnicity_income.png){width=100%, height=70%}
...
<font size="3"> Performing single parameter evaluation to have a baseline</font>

fig.allign = "center"


![](../results/Single_Prediction.png){width=60%, height=25.5%}
...
![](../results/Impact_Estimation_with_confidence_interval.png){width=90%}
...
Appears that older people who have diabetes tend to be treated more often than younger people with diabetes
